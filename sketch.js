...
function draw() {
  ...
  background(200);
  textSize(100);
  text('TOTAL CLICKS : '+cl,width/4.2,height/3.2);
  text('CPS : '+cps,width/4.2,height/2.5);
  text('HIGHEST CPS : '+h,width/4.2,height/2.1);
  text('AVERAGE CPS : '+round(b),width/4.2,height/1.8);
